...
local ShopUI = require(SummitClient:WaitForChild("ShopUI"))
local MusicPlayerUI = require(SummitClient:WaitForChild("MusicPlayerUI"))
local EmoteUI = require(SummitClient:WaitForChild("EmoteUI"))
local SettingsUI = require(SummitClient:WaitForChild("SettingsUI"))
...
function PhoneUI.GoToPage(pageIndex)
	...
	local contentFrame = phoneFrame:FindFirstChild("Content")
